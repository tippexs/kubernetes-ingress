...
class DosSetup:
    ...
    Attributes:
        ...
        req_url_https (str):
    """
    def __init__(self, req_url_http, req_url_https, pol_name, log_name):
        self.req_url_http = req_url_http
        self.req_url_https = req_url_https
...
def dos_setup(
    ...
    req_url_https = f"https://{ingress_controller_endpoint.public_ip}:{ingress_controller_endpoint.port_ssl}/"
    ...
    return DosSetup(req_url_http, req_url_https, pol_name, log_name)
...
class TestDos:
    def test_ap_nginx_config_entries(
        ...
        ensure_response_from_backend(dos_setup.req_url_http, ingress_host, check404=True)
